...
public class UserDaoImpl implements UserDao{
	...
	public boolean register(User user) {
		boolean flag = false;
		DBconn.init();
		int i =DBconn.addUpdDel("insert into t_user(name,pwd,sex,home,info) " +
    ...
    public boolean login(String name, String pwd) {
		...
		try {
			    DBconn.init();
				ResultSet rs = DBconn.selectSql("select * from t_user where name='"+name+"' and pwd='"+pwd+"'");
				while(rs.next()){
	...
	public boolean update(int id,String name, String pwd,String sex, String home,String info) {
		boolean flag = false;
		DBconn.init();
		String sql ="update t_user set name ='"+name
				+"' , pwd ='"+pwd
				+"' , sex ='"+sex
				+"' , home ='"+home
